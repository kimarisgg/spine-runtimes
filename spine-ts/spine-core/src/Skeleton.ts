...
import { Color, NumberArrayLike, Utils, Vector2 } from "./Utils"
...
export class Skeleton {
  ...
  /** Caches information about bones and constraints. Must be called if the {@link #skin} is modified or if bones,
