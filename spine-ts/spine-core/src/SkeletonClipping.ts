...
export class SkeletonClipping {
  ...
  clip(
    ...
    for (let i = 0; ; i += 2) {
      ...
      let edgeY = clippingVertices[i + 1]
      let edgeX2 = clippingVertices[i + 2]
      let edgeY2 = clippingVertices[i + 3]
      ...
      for (let ii = 0; ii < inputVerticesLength; ii += 2) {
        ...
        let inputY = inputVertices[ii + 1]
        let inputX2 = inputVertices[ii + 2]
        let inputY2 = inputVertices[ii + 3]
