...
import { MathUtils, NumberArrayLike, Utils } from "./Utils"
...
export class Animation {
   ...
   * @param lastTime
   * @param time
   * @param loop If true, the animation repeats after {@link #duration}.
   * @param alpha
   * @param blend
   * @param direction
...
export abstract class CurveTimeline implements Timeline {
  ...
  private curves: NumberArrayLike // type, x, y, ...
...
export class RotateTimeline extends CurveTimeline {
  ...
  frames: NumberArrayLike // time, degrees, ...
...
export class TranslateTimeline extends CurveTimeline {
  ...
  frames: NumberArrayLike // time, x, y, ...
...
export class ColorTimeline extends CurveTimeline {
  ...
  frames: NumberArrayLike // time, r, g, b, a, ...
...
export class TwoColorTimeline extends CurveTimeline {
  ...
  frames: NumberArrayLike // time, r, g, b, a, r2, g2, b2, ...
...
export class AttachmentTimeline implements Timeline {
  ...
  setFrame(frameIndex: number, time: number, attachmentName: string | null) {
    this.frames[frameIndex] = time
...
export class DeformTimeline extends CurveTimeline {
  ...
  constructor(frameCount: number, attachment: VertexAttachment) {
    super(frameCount)
    this.frames = Utils.newFloatArray(frameCount)
  ...
  apply(
    ...
    if (
      ...
      !((<VertexAttachment>slotAttachment).deformAttachment == this.attachment)
    ) {
      return
    }
...
export class DrawOrderTimeline implements Timeline {
   ...
   *           draw order. */
  setFrame(frameIndex: number, time: number, drawOrder: Array<number> | null) {
    this.frames[frameIndex] = time
...
export class IkConstraintTimeline extends CurveTimeline {
  ...
  frames: NumberArrayLike // time, mix, softness, bendDirection, compress, stretch, ...
...
export class TransformConstraintTimeline extends CurveTimeline {
  ...
  frames: NumberArrayLike // time, rotate mix, translate mix, scale mix, shear mix, ...
...
export class PathConstraintPositionTimeline extends CurveTimeline {
  ...
  frames: NumberArrayLike // time, position, ...
...
export class PathConstraintMixTimeline extends CurveTimeline {
  ...
  frames: NumberArrayLike // time, rotate mix, translate mix, ...
