...
export class AnimationState {
   ...
   * {@link TrackEntry#mixDuration}. Mixing from an empty animation causes the new animation to be applied more and
  ...
  computeHold(entry: TrackEntry) {
    ...
    let timelinesCount = timelines.length
...
export class TrackEntry {
  ...
  /** Seconds from 0 to the {@link #mixDuration} when mixing from the previous animation to this animation. May be
