...
import type { AnimationStateListener, TrackEntry } from "@kimarisgg/spine-core"
import {
  ClippingAttachment,
  MeshAttachment,
  PathAttachment,
      ...
      eventCallback: {
        event: (_, event) => {
          if (this.drawEvents) {
            ...
            const text = new Text(event.data.name, {
        ...
        start: function (entry: TrackEntry): void {},
        interrupt: function (entry: TrackEntry): void {},
        end: function (entry: TrackEntry): void {},
        dispose: function (entry: TrackEntry): void {},
        complete: function (entry: TrackEntry): void {}
      }
    }
